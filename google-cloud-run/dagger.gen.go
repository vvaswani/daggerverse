...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "GoogleCloudRun":
		...
		case "ContainerEcho":
			...
			return (*GoogleCloudRun).ContainerEcho(&parent, stringArg), nil
		case "GrepDir":
			var parent GoogleCloudRun
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*GoogleCloudRun).GrepDir(&parent, ctx, directoryArg, pattern)
		default:
	...
	case "":
		return dag.Module().
			WithObject(
				dag.TypeDef().WithObject("GoogleCloudRun").
					WithFunction(
